    ...
    public function dataTable()
    {
        ...
        return datatables($query)
            ...
            ->addColumn('actions', function (User $user) {
                ...
                <a data-content="' . __("Verify") . '" data-toggle="popover" data-trigger="hover" data-placement="top" href="' . route('admin.users.verifyEmail', $user->id) . '" class="btn btn-sm btn-primary mr-1"><i class="fas fa-envelope"></i></a>
